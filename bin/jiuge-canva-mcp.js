...
function registerToolWithLegacyAlias(name, legacyName, description, schema, handler) {
  server.tool(name, description, schema, handler);
  server.tool(legacyName, `${description} Legacy alias for compatibility.`, schema, handler);
}
